...
const AllServices = () => {
    ...
    useEffect(() => {
      ...
      if (loading) {
        return <div className="flex justify-center items-center content-center w-16 h-16 border-4 border-dashed rounded-full animate-spin dark:border-violet-500"></div>
    }
